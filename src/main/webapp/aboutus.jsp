  ...
  <body>
    ...
    >
      <div class="layout-container flex h-full grow flex-col">
        ...
        <div class="p-10">
          <h1
            class="text-3xl font-extrabold text-black text-center mb-10"
          >
            Our Team
          </h1>
          <!-- Team Grid -->
          <div class="grid grid-cols-4 gap-6">
            <!-- Card 1 -->
            <div class="bg-white rounded-lg shadow-2xl hover:shadow-3xl transition-shadow duration-300 p-6">
              <div class="flex flex-col items-center gap-6">
                <div
                  class="bg-center bg-no-repeat bg-cover rounded-full w-48 h-48"
                  style="background-image: url('https://i.ibb.co/PGj4w93/Mentor.png');"
                ></div>
                <a
            ...
            <div class="bg-white rounded-lg shadow-2xl hover:shadow-3xl transition-shadow duration-300 p-6">
              <div class="flex flex-col items-center gap-6">
                <div
                  class="bg-center bg-no-repeat bg-cover rounded-full w-48 h-48"
                  style="background-image: url('https://i.ibb.co/tBHR5F1/curator.jpg');"
                ></div>
                <a
            ...
            <div class="bg-white rounded-lg shadow-2xl hover:shadow-3xl transition-shadow duration-300 p-6">
              <div class="flex flex-col items-center gap-6">
                <div
                  class="bg-center bg-no-repeat bg-cover rounded-full w-48 h-48"
                  style="background-image: url('https://i.ibb.co/g6MV2X6/Nikhil.jpg');"
                ></div>
                <a
            ...
            <div class="bg-white rounded-lg shadow-2xl hover:shadow-3xl transition-shadow duration-300 p-6">
              <div class="flex flex-col items-center gap-6">
                <div
                  class="bg-center bg-no-repeat bg-cover rounded-full w-48 h-48"
                  style="background-image: url('https://i.ibb.co/m0cZvxF/Sat.png');"
                ></div>
                <a
